...
- 🧩 [AI 워크플로 자산](docs/agents.md#5-공급자-중립-ai-워크플로-자산-specs044) — `make skills-deploy` 한 번으로 goal-ready·goal-impl·sdd-self-review를 Claude Code·Codex·Gemini CLI에 배포(공급자 중립)
