...
## 검증 결과 (2026-07-20, self-review round 1 clean)

- [x] FR-1/AC-1·FR-2/AC-2 — 렌즈 병렬·병합 규칙 문구 계약 green (workflow-policy 신규 4블록)
- [x] FR-3/AC-3~7 — preflight 단위 16 + 통합 3 green, 실 실행 exit 1/0 도그푸드 관찰
- [x] FR-4/AC-8 — 게이트 문구 계약 green + 이번 구현 자체가 preflight→critic 순서 자기 적용
- [x] FR-5/AC-9 — 템플릿·SKILL §5 단일 필드셋 7 계약 green, round1 evidence가 스키마 자기 적용
- [x] FR-6/AC-10~12 — 집계·레거시 내성·렌더 green, retro-report §8 절 실관찰(미준수 4건 표기)
- [x] AC-13 — 전체 1017/1017 green ×3 (기존 계약 비회귀)
- advisory 3건(A1 동률 tie-break·A2 파서 이원화·A3 AC-id 과검출)은 완료 비차단 후속 후보 —
  evidence/self-review-round1.md 참조.
