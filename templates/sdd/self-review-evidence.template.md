...
carried-from: {{선택 — hermetic evidence 승계 시 출처, 예: "r1@5fc57b6"(rN@candidate 7자 SHA), 승계 없으면 줄 자체를 지운다}}
---
...
<!-- specs/202607201808-critic-efficiency FR-5 — self-review evidence frontmatter 표준.
     ...
     판독한다. 선택 3필드(duration-minutes·lenses·carried-from, specs/202607210545 FR-5로 확장)는
     있으면 채우고 없으면 줄 자체를 지운다.
